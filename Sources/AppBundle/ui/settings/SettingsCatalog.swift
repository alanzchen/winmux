...
enum SettingsCatalog {
    ...
    static let fields: [SettingsField] = {
        ...
        var result: [SettingsField] = [
            ...
            SettingsField(group: .placement, section: sidebar, key: "dock-position", title: "Position", help: "Bottom temporarily enables macOS Dock auto-hide and restores your previous setting afterward. In every position, WinMux hides while the macOS Dock is visible on that display.",
            ...
            bool(.placement, "stay-on-top", "Keep above the macOS Dock", "Applies to Sidebar mode. Dock mode always yields to the visible macOS Dock.", section: sidebar, path: \.workspaceSidebar.stayOnTop),
