...
enum SettingsCatalog {
    ...
    static let fields: [SettingsField] = {
        ...
        var result: [SettingsField] = [
            ...
            bool(.projects, "launcher-menu-fallback", "Use an app's New Window menu", "For apps WinMux has no tested adapter for, the launcher presses the app's own New Window menu item. Without it, those apps can only be switched to.", section: sidebar, path: \.workspaceSidebar.launcherMenuFallback),
